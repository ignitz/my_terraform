...
jupyter lab --NotebookApp.token='' --NotebookApp.ip='*' --NotebookApp.base_url=/jupyter --NotebookApp.notebook_dir=${HOME}/notebooks --NotebookApp.password="$(source /home/ubuntu/anaconda/bin/activate && python3 -c "from notebook.auth import passwd; print(passwd('${JUPYTER_PASSWORD}'))")"
EOT
